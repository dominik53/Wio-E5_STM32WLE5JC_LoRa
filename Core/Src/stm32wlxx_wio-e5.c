...
{
  return (int32_t)1;//__STM32WLXX_WIO-E5_BSP_VERSION;
}
...
{
  GPIO_InitTypeDef gpio_init_structure = {0};
  static BSP_EXTI_LineCallback button_callback[BUTTONn] = {BUTTON_SW1_EXTI_Callback, BUTTON_SW2_EXTI_Callback};
  static uint32_t button_interrupt_priority[BUTTONn] = {BSP_BUTTON_USER_IT_PRIORITY, BSP_BUTTON_USER_IT_PRIORITY};
  static const uint32_t button_exti_line[BUTTONn] = {(uint32_t)BUTTON_SW1_EXTI_LINE, (uint32_t)BUTTON_SW2_EXTI_LINE};
