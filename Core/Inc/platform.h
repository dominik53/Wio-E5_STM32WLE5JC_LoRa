...
/* USER CODE BEGIN EC */
#define USE_BSP_DRIVER // my custom wio-e5, if generated code YOU MUST comment out lines: #include "stm32wlxx_nucleo_radio.h" AND #include "stm32wlxx_nucleo.h"
/* USER CODE END EC */
...
#if defined(USE_BSP_DRIVER)
#include "stm32wlxx_wio-e5_radio.h" // read #define USE_BSP_DRIVER
