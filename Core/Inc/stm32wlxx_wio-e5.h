...
#ifndef STM32WLXX_WIO_E5_H
#define STM32WLXX_WIO_E5_H
...
/* Includes ------------------------------------------------------------------*/
#include "stm32wlxx_wio-e5_errno.h"
#include "stm32wlxx_wio-e5_conf.h"
//#include "stdint.h"
...
/** @defgroup STM32WLXX_WIO-E5 STM32WLXX-WIO-E5
  * @{
  */

/** @defgroup STM32WLXX_WIO-E5_LOW_LEVEL LOW LEVEL
  * @{
  */

/** @defgroup STM32WLXX_WIO-E5_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
typedef enum 
{
...
#define BUTTON_SW2_GPIO_PORT                    GPIOB
#define BUTTON_SW2_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOB_CLK_ENABLE()
#define BUTTON_SW2_GPIO_CLK_DISABLE()           __HAL_RCC_GPIOB_CLK_DISABLE()
...
#define BUTTONx_GPIO_CLK_ENABLE(__INDEX__)    do { if ((__INDEX__) == BUTTON_SW1) BUTTON_SW1_GPIO_CLK_ENABLE(); else \
                                              ...
                                              if ((__INDEX__) == BUTTON_SW3) BUTTON_SW2_GPIO_CLK_ENABLE();} while(0)
